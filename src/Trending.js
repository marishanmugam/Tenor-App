...
function Trending() {
    ...
    const fetchData = () => {
        axios
        .get ('https://tenor.googleapis.com/v2/trending_terms?key=AIzaSyDTHKhc9ujnqiwS2M29T_p6cTVSq9N0a2c')
        .then((res) => {
    ...
    const searchData = () => {
        axios.get(`https://tenor.googleapis.com/v2/search?key=AIzaSyDTHKhc9ujnqiwS2M29T_p6cTVSq9N0a2c&q=${featured}`)
        ...
        ser.map((e) => {
            return (
                <div className='trend-images' key={e.id}>
                    <div className='trend'>
                        <a href='#'> <img src={e.media_formats.gif.url}></img> </a>
                    </div>  
                </div>
